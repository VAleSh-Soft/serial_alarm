...
Пины для подключения экрана, модуля DS3231, кнопок и датчиков температуры и света определены в файле **clockSetting.h** (см. описание библиотеки [shSimpleClock](https://github.com/VAleSh-Soft/shSimpleClock/blob/main/docs/clock_setting.md)). Пины для подключения пищалки и светодиода задается в файле **header_file.h**.
