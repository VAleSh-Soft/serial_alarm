...
***ВАЖНО!!!** - настройки сигнализатора, в том числе минимальный и максимальный интервал срабатывания, задаются в файле **alarm.h***
...
В папке **bin** лежат скомпилированные файлы прошивки версии **1.5.9**.
