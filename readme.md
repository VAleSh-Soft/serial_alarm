...
В режиме отображения текущего времени удержание нажатой более секунды кнопки **Up** последовательно выводит на экран все точки времени, когда согласно текущих настроек будет срабатывать сигнализатор.
