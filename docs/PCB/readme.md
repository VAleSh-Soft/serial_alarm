...
Разъем для подключения **UART** необязателен к установке, т.к. в коде взаимодействие с интерфейсом не предусмотрено. Разъем использовался в процессе отладки прошивки. Заливка прошивки через этот разъем не предусмотрена, т.к. на плате не выведен вывод для **DTR** и кнопка **Reset** для МК.
